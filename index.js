...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
//nested function can access the variable internal because its looking outside of its scope
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(zooAnimals){
    const animalName = [];
   zooAnimals.forEach(animal => animalName.push(`name: ${animal.animal_name}, scientific: ${animal.scientific_name}`)); 
   return animalName;
  }
  ...
  */
  ...
  function lowerCaseNames(zooAnimals){ 
    const lower = zooAnimals.map((animal) => animal.animal_name.toLowerCase()); 
    return lower
  }
...
const filteredArray = zooAnimals.filter(obj => obj.population < 5);
...
console.log(lowPopulationAnimals);
  ...
  */
  ...
  function USApop(zooAnimals){
   const population = zooAnimals.reduce((acc, animal) => acc + animal.population, 0);
  return population
}
  console.log(USApop);
...
function greeting(firstName, lastName){
  ...
  console.log(greeting('Emma' , 'Regis'));
...
*/
 ...
 const chicken = new CuboidMaker({ length: 9, width: 4, height: 6})
console.log(chicken);
console.log(chicken.volume());
...
const friedChicken = new CuboidMaker({ length: 4, width: 7, height: 9 })
console.log(friedChicken.surfaceArea());
...
const burger = new CuboidMakerTwo ({ length: 9, width: 6, height: 1})
console.log(burger);
console.log(burger.volume);
console.log(burger.surfaceArea);
